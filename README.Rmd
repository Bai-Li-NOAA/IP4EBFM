...
IP4EBFM is a GitHub repository for a fisheries stock assessment projections project. The project aims to use an interdisciplinary projections to achieve climate-ready, ecosystem-based, sustainable fisheries management. 

## Repository structure

- We have a project meeting once a month and we keep meeting agenda and notes in our `Meeting_Notes` folder.
