...
BSR.time.plots(menhaden, start.drop = 10, draft=dtype, use.color=ctype, graphics.type=ptype, legend.pos="top")
...
Comp.yearly.plots(menhaden, draft=dtype, use.color=ctype, graphics.type=ptype, plot.neff=FALSE, print.neff=FALSE,
                  compact = TRUE, print.n=TRUE)

Cohort.plots(menhaden,draft=dtype, graphics.type=ptype)

Index.plots(menhaden, draft=dtype, use.color=ctype, graphics.type=ptype)
...
F.time.plots(menhaden, draft=dtype, use.color=ctype, graphics.type=ptype,
...
Eq.plots(menhaden, draft=dtype, use.color=ctype, graphics.type=ptype,
...
NFZ.age.plots(menhaden,draft=dtype, use.color=ctype, graphics.type=ptype,
...
#windows(width = 8, height = 8, record = TRUE)
Phase.plots(menhaden, start.drop=10, draft=dtype, use.color=ctype, graphics.type=ptype, year.pos=2)
