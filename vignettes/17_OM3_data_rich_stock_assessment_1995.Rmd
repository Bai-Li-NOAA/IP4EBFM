---
title: 'OM3 data-rich stock assessment (1995) with low CV in data and without environmental link in the estimation model'
date: "`r Sys.Date()`"
output:
  html_document: 
    code_folding: hide
