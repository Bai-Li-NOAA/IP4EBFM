...
- Observed a very high proportion of fish in length bin 10.5 cm
  - need to check selectivity-at-age 0 and perhaps modify selectivity pattern for survey nad
...
## Modify selectivity pattern for survey nad and update length bins

- Change `slope_asc` from 2.2 to 2.5: 
...
colnames(nad) <- paste0("ages", ages)

survey_selectivity$nad <- nad

# set up age-length population structure
length_bin <- seq(10, 460, 10)/10 # in cm
mid_length_bin <- seq(15, 465, 10)/10 # in cm
nbin <- length(length_bin)
bin_width <- 1
