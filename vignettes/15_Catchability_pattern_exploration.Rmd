...
Notably, for the latter, the relationship with biomass is positive. Catches tend 
...
future biomass is also smaller on average. In addition, specifying catchability 
likely doesn't affect the indicator in the this plot, which is largely driven by 
catches (which is a function of biomass?).

For the former, the relationship with biomass is negative. This is due 
