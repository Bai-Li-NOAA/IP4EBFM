---
title: 'OM3 data-rich stock assessment (2012)'
date: "`r Sys.Date()`"
output:
  html_document: 
    code_folding: hide
...
plot(x, biomass_f0_menhaden,
  xlab = "Year", ylab = "Biomass of menhaden-like species",
  lty = 1, type = "l"
)
...
yrange <- range(abundance0_f0_menhaden, abundance0_f0_all)
...
## Case 0: stock assessment base run (terminal year = 2012)
