...
knitr::kable(scenarios[, c("scenario_id", "driver_code", "driver_name", "driver_category", "justification", "data_source", "sum_of_squared_differences")])
```
## Relative biomass
...
```{r, results='hide', echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=10}
heatmap(bratio, Rowv = NA, Colv = NA,
