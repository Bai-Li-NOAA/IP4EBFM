...
time_id <- seq(1, nrow(biomass_s2[[1]]), by = 12)[1:(length(model_year))]
...
time_id <- seq(1, nrow(biomass_s3[[1]]), by = 12)[1:(length(model_year))]
...
knitr::kable(bratio_table,
  caption = "Table 6. Bratio output from catch over F output"
)
