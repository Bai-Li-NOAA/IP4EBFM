...
names(bmsy_table) <- c(
  ...
  "compensation_bmsy_s1_MaxCatchVec",
  "stationary_bmsy_s1_MaxSumCatch",
  "stationary_bmsy_s1_MaxCatchVec",
  "compensation_bmsy_s2_MaxSumCatch",
  "compensation_bmsy_s2_MaxCatchVec",
  "stationary_bmsy_s2_MaxSumCatch",
  "stationary_bmsy_s2_MaxCatchVec"
)
knitr::kable(bmsy_table,
  caption = "Table 5. BMSY output from catch over F output"
)
