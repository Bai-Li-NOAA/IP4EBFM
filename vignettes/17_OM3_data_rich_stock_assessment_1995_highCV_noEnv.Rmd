---
title: 'OM3 data-rich stock assessment (1995) with high CV in data and without environmental link in the estimation model'
date: "`r Sys.Date()`"
output:
  html_document: 
    code_folding: hide
...
scenario_filename <- "_highCV_noEnv"
...
# MCMC run
run_mcmc <- FALSE
mcmc_dir <- here::here(dirname(here::here()), paste0("OM3_mcmc_", terminal_year, scenario_filename))
...
projection_file_path <- here::here("data", "data_rich", paste0("OM3_projections_", terminal_year, scenario_filename))
...
write.csv(fmsy_data_melt, here::here("data", "data_rich", paste0("fmsy_data", terminal_year, scenario_filename, ".csv")))
write.csv(projection_f, here::here("data", "data_rich", paste0("fmsy_median_data", terminal_year, scenario_filename, ".csv")))
