...
for (i in 1:length(levels(biomass_projection$tac))){
  ...
  c(
    median(biomass_projection$bk[biomass_projection$year == tail(projection_year, n=1) & 
                     biomass_projection$tac == as.numeric(levels(biomass_projection$tac)[i])]),
    ...
    median(biomass_projection$harvest[biomass_projection$year == tail(projection_year, n=1) & 
                     biomass_projection$tac == as.numeric(levels(biomass_projection$tac)[i])]),
    as.numeric(levels(biomass_projection$tac)[i]),
    
    mean(projected_biomass$biomass[projected_biomass$tac == as.numeric(levels(biomass_projection$tac)[i])])
...
legend(x=0.7, y=1, legend = rownames(evaluation_table[-c(1,2),]), bty = "n", pch=20 , col=colors_in , text.col = "grey", cex=1.2, pt.cex=3)
