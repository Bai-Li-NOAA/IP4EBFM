...
- Case that does not include catch-per-unit-effort (CPUE) data
  - Input: K = 3500000, r = 0.2, B1985/K = 0.7
  - Output: K = 3971960.342, r = 0.203, B1985/K = 0.691
- Case that includes CPUE data
  - Input: K = 3500000, r = 0.6, B1985/K = 0.7
  - Output: K = 3758380.770	, r = 0.553, B1985/K = 0.708
...
ss_case0_input_noEffort$jagsdata$psi.pr <- c(0.7, 0.1)
...
ss_case0$estimates
write.csv(ss_case0$estimates, here::here("data", "data_moderate", "case0_estimates.csv"))

# Plot figures using JABBA
JABBA::jabba_plots(jabba = ss_case0_noEffort, output.dir = output_dir)
...
variable_label <- c("Average Catch", "B2017/K", "B2017/BMSY", "Average Biomass", "Bonanza", "Collapse")
for (i in 1:case_num){
