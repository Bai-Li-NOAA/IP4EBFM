...
for (i in 1:case_num){
  colors_border <- palette.colors(palette = "Okabe-Ito")[c(1:2, 2+i)]
  radarchart(evaluation_table[c(1:4, i+4), ],
             seg=5,
  ...
  legend(x=-0.5, y=1.9, legend = rownames(evaluation_table)[c(3:4, 4+i)], bty = "n", pch=20 , col=colors_border, text.col = "black", cex=0.9, pt.cex=3)
}


colors_border <- palette.colors(palette = "Okabe-Ito")[1:(nrow(evaluation_table)-2)]
...
legend(x=-1, y=1.9, legend = rownames(evaluation_table[-c(1,2),]), bty = "n", pch=20 , col=colors_border, text.col = "black", cex=0.9, pt.cex=3, ncol=2)
```
